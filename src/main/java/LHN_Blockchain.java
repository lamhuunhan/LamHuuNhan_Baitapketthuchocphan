...
public class LHN_Blockchain {

    public static ArrayList<VNPT_Nhan> blockchain = new ArrayList<VNPT_Nhan>();
    ...
    public static void main(String[] args) {
        ...
        VNPT_Nhan genesis = new VNPT_Nhan("0");
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);

        //Thử nghiệm
        VNPT_Nhan block1 = new VNPT_Nhan(genesis.hash);
    ...
    public static Boolean isChainValid() {
        VNPT_Nhan currentBlock;
        VNPT_Nhan previousBlock;
    ...
    public static void addBlock(VNPT_Nhan newBlock) {
